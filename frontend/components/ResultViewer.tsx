            ...
            <div className="flex-1 overflow-y-auto pr-2 space-y-4 custom-scrollbar">
              {displayItems.length > 0 ? (
                displayItems.map((item, index) => (
                  <div
                    key={index}
                    className="group p-4 border border-orange-100 rounded-2xl hover:border-orange-accent hover:shadow-md transition-all duration-300 bg-white"
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-xs text-orange-accent font-medium uppercase tracking-wide mb-2">
                          {item.category}
                        </p>
