    ...
    <div className="max-w-3xl mx-auto">
      <div className="text-center mb-12 space-y-6">
        ...
        <p className="text-gray-700 max-w-3xl mx-auto text-2xl font-['Inter'] font-light leading-relaxed">
          Transform your empty space into a stunning, personalized sanctuary
          with AI-powered interior design. Upload a photo and let us bring your
          vision to life.
        </p>
      </div>

      <div
        className={`bg-white p-12 rounded-[2rem] shadow-sm border-3 border-dashed transition-all duration-300 ${
          isDragging
              ...
              {isDragging ? (
                <>
                  <div className="mb-6 relative">
                    <UploadIcon
                      className={`w-16 h-16 text-orange-400 animate-bounce`}
                      strokeWidth={1.5}
                    />
